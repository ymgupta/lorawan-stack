...
class ConfigurationStep {
  ...
  selectLorawanVersion(version) {
    cy.selectOption('LoRaWAN version', version)
  }
...
class NetworkLayerStep {
  selectFrequencyPlan(plan) {
    cy.selectOption('Frequency plan', plan)
  }

  selectPhyVersion(version) {
    cy.selectOption('Regional Parameters version', version)
  }
  ...
  selectPingSlotPeriodicity(periodicity) {
    cy.selectOption('Ping Slot Periodicity', periodicity)
  }
